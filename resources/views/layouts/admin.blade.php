            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar"
                        ...
                        class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden focus:ring-2 focus:ring-gray-200 text-gray-400 hover:bg-gray-700 dark:focus:ring-gray-600">
                ...
                <div class="flex items-center">
                    <div class="flex items-center ml-3">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none divide-y divide-gray-100 rounded shadow bg-gray-700 divide-gray-600"
                            id="dropdown-user">
