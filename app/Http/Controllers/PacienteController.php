...
class PacienteController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $historiales = Historial::where('paciente_id', $id)
        ->with('medico', 'seguimientos')
        ->paginate(20);
        $recetas = Receta::with('medicamentos', 'medico')->where('paciente_id', $id)->get();
        return view('paciente.show', compact('paciente','historiales','recetas'));
    }
